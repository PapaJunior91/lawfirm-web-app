        ...
        <div class="col-md-3 left_col">
            <div class="left_col scroll-view">
                <div class="navbar nav_title app-border">
                    <a href="{{url('')}}" class="site_title" style="background-color: #F7DC6F;color: #2A3F54;font-weight: bolder;">

                        <!-- <span style="color: #2A3F54;">{{ $image_logo->company_name ?? '' }}</span></a> -->
                        <span style="color: #2A3F54;">TRA</span></a>
                </div>
